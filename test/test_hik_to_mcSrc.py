...
def makeMCAssets(sourceFolderPath, outputFolderPath):
    ...
    for i, sourceFile in enumerate(sourceFiles):
        batch(sourceFile, motionCaptureFolder, animClipFolder, previewFolder)
...
def batch(mocapSrcFile, outputFoler_motionCapture, outputFoler_ainmClip, outputFolder_playblast):
    ...
    exportNodes = pm.ls( type=['mesh', 'joint', 'character', 'HIKCharacterNode'] )
